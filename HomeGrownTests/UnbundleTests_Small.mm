...
@interface UnbundleTests_Small : XCTestCase
@end

@implementation UnbundleTests_Small
...
- (void)test_100_full_spectrum {
    ...
    for (int aPayloadBytesPerBlock=1;aPayloadBytesPerBlock<=24;aPayloadBytesPerBlock+=1) {
        printf("aPayloadBytesPerBlock = %d\n", aPayloadBytesPerBlock);
        
        for (int aBlocksPerArchive=1;aBlocksPerArchive<=8;aBlocksPerArchive+=1) {
