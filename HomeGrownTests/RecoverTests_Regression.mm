...
- (void)test_recover_regression_small_window_l {
    JobBundle aJob;
    aJob.mPayloadBytesPerBlock = 4;
    aJob.mBlocksPerArchive = 4;
    aJob.mPreviewEnabled = 0;
    ...
    // Files
    aJob.AddFile("Cあwا.UwnI", "⭐Ξx");
    aJob.AddFolder("LiあT");
    aJob.AddFile("cl", "D");
    aJob.AddFile("ث.w", "U电ZΦz");
    aJob.AddFile("⭐FP.KckRuJ", "k龙人oVn");
    aJob.AddFile("め.z", "aVتx");
    ...
    int aArchiveIndex2 = 14;
    int aBlockIndex2 = 3;
    string aArchiveName2 = "/root/archived/bdl_14.PBTR";
