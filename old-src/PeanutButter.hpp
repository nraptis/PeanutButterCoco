...
#define PASSWORD_EXPANDED_SIZE 7680u
#define PASSWORD_BALLOONED_SIZE 15360u
...
static_assert(PASSWORD_BALLOONED_SIZE == (PASSWORD_EXPANDED_SIZE * 2u),
...
static_assert(kExpandedBuffersPerL1 == 34u,
              "BLOCK_SIZE_L1 must hold exactly 34 expanded buffers.");
static_assert(kBalloonedBuffersPerL1 == 17u,
              "BLOCK_SIZE_L1 must hold exactly 17 ballooned buffers.");
