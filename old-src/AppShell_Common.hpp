...
inline constexpr double kBundleProgressFactorDiscovery = 0.0;
inline constexpr double kBundleProgressFactorExpansion = 0.10;
inline constexpr double kBundleProgressFactorLayerCake = 0.0;
...
inline constexpr double kUnbundleProgressFactorDiscovery = 0.0;
inline constexpr double kUnbundleProgressFactorExpansion = 0.10;
inline constexpr double kUnbundleProgressFactorLayerCake = 0.0;
